...
/*   Updated: 2025/04/11 08:38:34 by layang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* 
if (curr_token->type == AND && g_status != 0)
	skip_next_command();
else if (curr_token->type == OR && g_status == 0)
	skip_next_command();
 */
