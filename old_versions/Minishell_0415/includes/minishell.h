...
/*   Updated: 2025/04/15 17:48:32 by nimorel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
***(Nico on 0415) echo modificaitons
1: Minishell.h add functions prototypes
2: Makefile add lexer_dquote.c and lexer_dquote_utils.c
3: modif echo.c
4: modif ft_lexer and ft_handle_env_var in lexer.c
5: modif ft_handle_word in lexer_utils.c normnette not ok
6: create lexer_dquote.c
7: create lexer_dquote_utils.c
*/
